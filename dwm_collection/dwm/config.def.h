...
static const char *fonts[] = {"Iosevka Nerd Font",
                              "JetBrainsMono Nerd Font:size=10",
                              "monospace:size=12", "JoyPixels:pixelsize=12:"};
...
static const char *dmenucmd[] = {
    "dmenu_run", "-c",      "-l",  dmenulist, "-m",  dmenumon,
...
static const char *compositorcmd[] = {"picom", "--experimental-backend"};
static const char *rofipower[] = {
    "/home/siyo/.config/rofi/scripts/powermenu.sh"};
...
static const StatusCmd statuscmds[] = {
    ...
    {"/opt/dblocks_modules/backlight.sh", 1},
    {"/opt/dblocks_modules/volume.sh", 10},
    {"/opt/dblocks_modules/cpu.sh", 3},
    {"/opt/dblocks_modules/memory.sh", 4},
    {"/opt/dblocks_modules/network.sh", 5},
...
static Key keys[] = {
    ...
    {MODKEY | ShiftMask, XK_p, spawn, {.v = compositorcmd}},
    ...
    {MODKEY | ShiftMask, XK_Right, spawn,
     SHCMD("~/.config/scripts/wallpaper_toggler.sh 1")},
