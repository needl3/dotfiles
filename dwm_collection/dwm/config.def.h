...
static const StatusCmd statuscmds[] = {
	...
	{ "subl /opt/dblocks_modules//backlight.sh"		,						1 },
	{ "subl /opt/dblocks_modules/volume.sh"			,						2 },
	{ "subl /opt/dblocks_modules/cpu.sh"			,						3 },
	{ "subl /opt/dblocks_modules/memory.sh"			,						4 },
	{ "subl /opt/dblocks_modules/network.sh"		,						5 },
	{ "subl /opt/dblocks_modules/updates.sh"		,						6 },
	{ "subl /opt/dblocks_modules/battery.sh"		,						7 },
	{ "subl /opt/dblocks_modules/date.sh"			,						8 },
	{ "subl /opt/dblocks_modules/date.sh"			,						9 },	
};
